...
(cl:defmethod cl:initialize-instance :after ((m <MsgEmission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgEmission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laam_laser_control-msg:<MsgEmission> is deprecated: use laam_laser_control-msg:MsgEmission instead.")))

(cl:ensure-generic-function 'emission-val :lambda-list '(m))
(cl:defmethod emission-val ((m <MsgEmission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laam_laser_control-msg:emission-val is deprecated.  Use laam_laser_control-msg:emission instead.")
  (emission m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MsgEmission>)))
  ...
  "laam_laser_control/MsgEmission")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MsgEmission)))
  "Returns string type for a message object of type 'MsgEmission"
  "laam_laser_control/MsgEmission")
