...
;//! \htmlinclude MsgPosition.msg.html

(cl:defclass <MsgPosition> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass MsgPosition (<MsgPosition>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MsgPosition>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MsgPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_monitoring-msg:<MsgPosition> is deprecated: use camera_monitoring-msg:MsgPosition instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MsgPosition>))
...
(cl:defmethod x-val ((m <MsgPosition>))
...
(cl:defmethod z-val ((m <MsgPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_monitoring-msg:z-val is deprecated.  Use camera_monitoring-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'R-val :lambda-list '(m))
(cl:defmethod R-val ((m <MsgPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_monitoring-msg:R-val is deprecated.  Use camera_monitoring-msg:R instead.")
  (R m))

(cl:ensure-generic-function 'P-val :lambda-list '(m))
(cl:defmethod P-val ((m <MsgPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_monitoring-msg:P-val is deprecated.  Use camera_monitoring-msg:P instead.")
  (P m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MsgPosition>) istream)
  "Deserializes a message object of type '<MsgPosition>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MsgPosition>)))
  "Returns string type for a message object of type '<MsgPosition>"
  "camera_monitoring/MsgPosition")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MsgPosition)))
  "Returns string type for a message object of type 'MsgPosition"
  "camera_monitoring/MsgPosition")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MsgPosition>))
