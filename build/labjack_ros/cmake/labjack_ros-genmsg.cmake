...
set(MSG_I_FLAGS "-Ilabjack_ros:/home/chenlequn/laam_control_ws/src/labjack_ros/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chenlequn/laam_control_ws/src/labjack_ros/msg/MsgLabJack.msg" NAME_WE)
add_custom_target(_labjack_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "labjack_ros" "/home/chenlequn/laam_control_ws/src/labjack_ros/msg/MsgLabJack.msg" ""
)
...
_generate_msg_cpp(labjack_ros
  "/home/chenlequn/laam_control_ws/src/labjack_ros/msg/MsgLabJack.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/labjack_ros)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/labjack_ros\")")
  # install generated code
  install(
